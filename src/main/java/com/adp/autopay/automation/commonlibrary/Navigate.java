...
public class Navigate extends CustomWebElement {

	public static boolean NavigateToMenu(ExecutionContext context,String Menu){
			
			List<WebElement> menuList = FindElements(context, By.xpath(".//ul[@class='menu']//li//span"));
...
//public static boolean NavigateTo(ExecutionContext context, String strMainMenu, String strSubMenu){		
//		try{
//			
...
//					List<WebElement> menuItemList = menuPopup.findElements(By.xpath(".//span[@class[starts-with(.,'dijit dijitReset dijitInline revitMegaItem')]]"));					
//					
...
//	}
	...
	public static boolean Revit_NavigateTo(ExecutionContext context, String strMainMenu, String strSubMenu){
		try{
...
//					String sNavItemID = element.getAttribute("id");
	...
	public static boolean NavigateTo(ExecutionContext context, String strMainMenu, String strSubMenu,String StrMenuItem){		
		try{

...
public class DataHelper {
    ...
    public static boolean blnEmailForOutputJon=false;
    public static boolean blntempEmailJsonResponse;
    public static List<String> lstrOutpuFileName = new ArrayList<String>();
    public static List<String> lstrTempFileName= new ArrayList<String>();
                        ...
                        switch (cellType)
                        {
                            ...
                            case Cell.CELL_TYPE_STRING:
                               //Mahesh  System.out.println(currentCell.getStringCellValue() + "\t" + " : currentRow : " + HeaderRow.getCell(j).getStringCellValue());
                                ...
                                if(header.equalsIgnoreCase("BaseUrl")) {
                                  ...
                                  //  dataObject.setSm_serversessionid(currentCell.getStringCellValue());
                                ...
                                } else if(header.equalsIgnoreCase("HEADER Parameters")) {
                                    ...
                                    {
                                    	String[] arrHdrEles = currentCell.getStringCellValue().split("[\\r\\n]+");
                                    	for(String strHeader:arrHdrEles)
                                    	{
                                    		String[] astrHeader = strHeader.split(":=");
                                    		dataObject.getHeaders().add(astrHeader[0].trim() + "=" + astrHeader[1].trim());
                                    	}
                                    }
                                    //dataObject.getHeaders().add(headersStr[1] + "=" + currentCell.getStringCellValue());
                                } else if(header.equalsIgnoreCase("URL Parameters")) {
                                	...
                                	if (currentCell.getStringCellValue().equalsIgnoreCase("*BLANK*")){
                                     ...
                                     {
                                    	String[] arrHdrEles = currentCell.getStringCellValue().split("[\\r\\n]+");
                                    	//if (currentCell.getStringCellValue().contains("GET_ITEMID_FROM_ROW")){
                                    		//String strVal = getItemsIDs(arrHdrEles, dataObject.getBaseUrl());
                                    		///if (!strVal.equals("")){
                                    			//dataObject.getUrlParams().put("ITEMID", strVal);
                                    		//}
                                    	//} else{
